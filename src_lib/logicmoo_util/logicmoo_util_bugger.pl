...
*/
dmsg1(skip_dmsg(_)):-!.
dmsg1(C):-tlbugger:dmsg_hidden(Hide),matches_term(Hide,C),!.
...
mesg_color(T,C):-defined_message_color(Pattern,C),matches_term(Pattern,T),!.
...
functor_color(F,C):- defined_message_color(F/_,C),!.
