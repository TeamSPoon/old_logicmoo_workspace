...
clientEvent(Channel,Agent,english(phrase([wordnet,ID|_],Codes),_)):-
      findall(String,'#$wnS'(ID,_, String, _, _,_, _, _G190),Out),fmt((Out)).
...
convertWNSToCycMap0:-
   ...
   fmt('~q.~n',[saved('#$wnS'(CycString, A, '$stringSplit'(MultiwordString), CycPOS, B, C),'#$WordnetCompleteMt',_,['#$wnS',CycString, '$stringSplit',CycPOS|MultiwordString])]),fail.
...
convertWNSToCycMap1:-
      ...
      fmt('saved(\'#$wnHypernym\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnHypernym\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap2:-
      ensure_loaded(wn_ent),
      ent(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnEntailment\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnEntailment\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap3:-
      ensure_loaded(wn_sim),
      sim(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnSimilarInMeaning\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnSimilarInMeaning\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap4:-
      ensure_loaded(wn_mm),
      mm(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnMemberMeronym\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnMemberMeronym\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap5:-
      ensure_loaded(wn_ms),
      ms(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnSubstanceMeronym\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnSubstanceMeronym\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap6:-
      ensure_loaded(wn_mp),
      mp(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnPartMeronym\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnPartMeronym\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap7:-
      ensure_loaded(wn_cs),
      cs(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnCauses\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnCauses\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap8:-
      ensure_loaded(wn_vgp),
      vgp(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnVerbsSimilarInMeaning\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnVerbsSimilarInMeaning\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMap9:-
      ensure_loaded(wn_at),
      at(NN,AA),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnAttribute\'(\'~w\',\'~w\'),\'#$WordnetCompleteMt\',_,[\'#$wnAttribute\',\'~w\',\'~w\']).~n',[N,A,N,A]),fail.

convertWNSToCycMapA:-
      ensure_loaded(wn_ant),
      ant(NN,X,AA,Y),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnAntonymous\'(\'~w\',~w,\'~w\',~w),\'#$WordnetCompleteMt\',_,[\'#$wnAntonymous\',\'~w\',\'~w\']).~n',[N,X,A,Y,N,A]),fail.

convertWNSToCycMapB:-
      ensure_loaded(wn_sa),
      sa(NN,X,AA,Y),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnFollowsInMeaning\'(\'~w\',~w,\'~w\',~w),\'#$WordnetCompleteMt\',_,[\'#$wnFollowsInMeaning\',\'~w\',\'~w\']).~n',[N,X,A,Y,N,A]),fail.

convertWNSToCycMapC:-
      ensure_loaded(wn_ppl),
      ppl(NN,X,AA,Y),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnAdjectiveParticiple\'(\'~w\',~w,\'~w\',~w),\'#$WordnetCompleteMt\',_,[\'#$wnAdjectiveParticiple\',\'~w\',\'~w\']).~n',[N,X,A,Y,N,A]),fail.

convertWNSToCycMapD:-
      ensure_loaded(wn_per),
      per(NN,X,AA,Y),
      idToPos(NN,N),idToPos(AA,A),
      fmt('saved(\'#$wnAdjectivePertains\'(\'~w\',~w,\'~w\',~w),\'#$WordnetCompleteMt\',_,[\'#$wnAdjectivePertains\',\'~w\',\'~w\']).~n',[N,X,A,Y,N,A]),fail.
