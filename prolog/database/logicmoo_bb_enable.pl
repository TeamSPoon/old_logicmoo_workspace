...
clientEvent(Channel,Agent,Options):-memberchk(submit='Disable Assertion',Options),!,
	...
	fmt('<H3><Font Color=Red>Disabling....</Font></H3>',[]),
...
disable_assertion(AID):-fmt('<H3><Font Color=Red>Done.</Font></H3>',[]).

disable_assertion_disp(Form,SURF,Vars,Context,AID,Maintainer):-
	toMarkup(html,SURF,Vars,SAtom),
	fmt('<IMG src="pixmaps/bullet.gif" asrtid=~w><nobr>',[AID]),
	fmt('<b>~w</b> ID<font color=red>~w</font> in Context: <font color=green>~w</font>  CTX: <font color=green>~w</font>  Maintainer: <font color=green>~w</font>',[Form,AID,Context,Maintainer]),
...
show_disable_assertions(Form,SURF,Vars,Context,AID,Maintainer,OnOff):-
	toMarkup(html,SURF,Vars,SAtom),
	fmt('<IMG src="pixmaps/bullet.gif" asrtid=~w><nobr>',[AID]),
	fmt('~w <b>~w</b> ID<font color=red>~w</font> in Context: <font color=green>~w</font>  CTX: <font color=green>~w</font>  Maintainer: <font color=green>~w</font>',[OnOff,Form,AID,Context,Maintainer]),
	%format_o('&nbsp;&nbsp;~w&nbsp;Enabled&nbsp;&nbsp;<br>',chectheoryox(AID,OnOff)),
	fmt('~w<hr>',[SAtom]),!.
...
clientEvent(Channel,Agent,Options):-memberchk(submit='Enable Assertion',Options),!,
	...
	getMooOption(Agent,user='Web',Agent),
	getMooOption(Agent,interp='kif',Interp),
	fmt('<H3><Font Color=Red>Enabling....</Font></H3>',[]),
...
enable_assertion(AID):-fmt('<H3><Font Color=Red>Done.</Font></H3>',[]).
...
show_enable_assertions:-fmt('<H3><Font Color=Red>Done.</Font></H3>',[]).
