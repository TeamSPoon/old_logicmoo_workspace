...
% mpred_f/1,mpred_f/2,mpred_f/3,mpred_f/4,mpred_f/5,mpred_f/6,mpred_f/7,
mpred_module/2,
...
props/2,ptReformulatorDirectivePredicate/1,pttp1a_wid/3,pttp_builtin/2,pttp_nnf_pre_clean_functor/3,quasiQuote/1,relationMostInstance/3,resolveConflict/1,
