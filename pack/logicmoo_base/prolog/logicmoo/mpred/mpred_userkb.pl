...
%
resolveConflict0(C) :- cwc, forall(must(mpred_negation_w_neg(C,N)),ignore(show_failure(why,(nop(baseKB:resolveConflict(C)),pp_db_why(N))))),
  ignore(show_failure(why,(nop(baseKB:resolveConflict(C)),pp_db_why(C)))), 
