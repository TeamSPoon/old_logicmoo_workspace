...
decl_mpred_0(C,More):-compound(C),C=..[F,Arg1|PROPS],a(ttRelationType,F),!,ground(Arg1),call(call,decl_mpred(Arg1,[F,PROPS,More])).
decl_mpred_0(C,More):-compound(C),C=..[F,Arg1|PROPS],a(ttPredType,F),!,ground(Arg1),call(call,decl_mpred(Arg1,[F,PROPS,More])).
...
%
glean_pred_props_maybe_some(G):- fail,compound(G),G=..[F,Arg1|RGS],call_u(ttRelationType(F)),call(call,add_mpred_prop_gleaned(Arg1,[F|RGS])).
