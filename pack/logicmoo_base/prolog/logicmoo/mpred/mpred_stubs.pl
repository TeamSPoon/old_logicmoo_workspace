...
has_storage_stub(Head):-       
      ...
      (((show_failure(has_storage_stub,predicate_property(PHead,number_of_clauses(1)))),(show_failure(has_storage_stub,predicate_property(PHead,number_of_rules(1)))))
