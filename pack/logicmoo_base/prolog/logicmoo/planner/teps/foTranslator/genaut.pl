...
%% size_fla(+F,?N)
%%
%% Unifies N with the size of formula F
...
%% simplify_nnf(+F,?Fp)
%%
%% Unifies Fp with a simplified version of F
%% This predicate does a very simple simplification.
%% Only simple things such as not(true) would be simplified.
...
% Gerth et al. 95 algorithm for f-FOLTL
% See AAAI06 paper for details
...
%% genaut(+Fla,?Aut)
%%
%% Unifies Aut with a transition-labeled PNFA that accepts models
%% of Fla.
