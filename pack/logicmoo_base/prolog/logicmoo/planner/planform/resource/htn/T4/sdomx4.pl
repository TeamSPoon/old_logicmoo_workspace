...
objects(clocation, [ 
                        ...
                        city1_cl1_z,city1_cl2_z,city2_cl1_z,city3_cl1_z,
...
objects(rail_route,[
                        ...
                        rail_route_2_z,rail_route_3_z ,
                        rail_route_2_y,rail_route_3_y ,
                        rail_route_2,rail_route_3 ]).
objects(truck, [
                        truck_1_x, truck_2_x, truck_3_x, truck_11_x, truck_22_x, truck_33_x,
                        truck_1_z, truck_2_z, truck_3_z, truck_11_z, truck_22_z, truck_33_z,
                        truck_1_y, truck_2_y, truck_3_y, truck_11_y, truck_22_y, truck_33_y,
...
objects(package,[pk_1, pk_2, pk_3, pk_4, pk_5, pk_6, 
                  ...
                  pk_1_z, pk_2_z, pk_3_z, pk_4_z, pk_5_z, pk_6_z,
                  pk_1_y, pk_2_y, pk_3_y, pk_4_y, pk_5_y, pk_6_y]).
...
atomic_invariants([
      ...
      in_city(city3_cl1_z,city3_z), in_city(city3_ts1_z,city3_z),
...
method(
  ...
  [ sc(package, P, [at(P,O),waiting(P),certified(P)] =>
      ...
      [ ne(O,D), is_of_sort(O,airport), is_of_sort(D,airport),
...
method(
 ...
 [   %  achieve(ss(traincar,V,[moveable(V), busy(V)])),
       commission(V),
