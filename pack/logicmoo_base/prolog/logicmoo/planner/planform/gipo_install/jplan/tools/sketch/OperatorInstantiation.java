 ...
 * @author Ron
 * New version for ocl plus based on Weihong's code
 */
...
public class OperatorInstantiation extends javax.swing.JDialog {
	...
	public OperatorInstantiation(
		...
		super(top, "Operator Instantiation Window");
						...
						try {
							...
							if (popupMenu.getComponentCount() > 0) {
								...
								Utility.debugPrintln(
									"No object items in the popup menu.");
							}
	...
	private void jbn_OKActionPerformed() {
		...
		if (parent == null)
			return;
		parent.getPlanControl().showInstantiatedOperator(operator);
	}
