...
mktemp(Template, FileName) :-
   c_mktemp(Template, FileName0, Res),
   mktemp_result(Res, Template, FileName0,FileName).
...
%-------------------------------------------------------------------------
%  sp_win32_times(-KernelHigh,-KernelLow, -UserHigh,-UserLow, Res)
%  Res is 1 on succes.
%  KernelHigh/Low form a 64bit integer in 100ns units of process time spent in Kernel mode
%  UserHigh/Low ditto for user mode.
