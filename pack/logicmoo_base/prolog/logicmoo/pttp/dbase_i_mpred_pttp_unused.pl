...
:- shared_multifile int_unknown_t/13.


:- was_dynamic answerable_t/13.
:- shared_multifile answerable_t/13.


:- was_dynamic int_unknown_t/12.
:- shared_multifile int_unknown_t/12.


:- was_dynamic answerable_t/12.
:- shared_multifile answerable_t/12.


:- was_dynamic int_unknown_t/11.
:- shared_multifile int_unknown_t/11.


:- was_dynamic answerable_t/11.
:- shared_multifile answerable_t/11.


:- was_dynamic int_unknown_t/10.
:- shared_multifile int_unknown_t/10.
...
:- shared_multifile answerable_t/10.


:- was_dynamic int_unknown_t/9.
:- shared_multifile int_unknown_t/9.


:- was_dynamic answerable_t/9.
:- shared_multifile answerable_t/9.
...
:- shared_multifile int_unknown_t/8.


:- was_dynamic answerable_t/8.
:- shared_multifile answerable_t/8.


:- was_dynamic int_unknown_t/7.
:- shared_multifile int_unknown_t/7.


:- was_dynamic answerable_t/7.
:- shared_multifile answerable_t/7.


:- was_dynamic int_not_possible_t/13.
:- shared_multifile int_not_possible_t/13.


:- was_dynamic int_possible_t/13.
:- shared_multifile int_possible_t/13.


:- was_dynamic not_possible_t/13.
:- shared_multifile not_possible_t/13.


:- was_dynamic int_not_possible_t/12.
:- shared_multifile int_not_possible_t/12.


:- was_dynamic int_possible_t/12.
:- shared_multifile int_possible_t/12.


:- was_dynamic not_possible_t/12.
:- shared_multifile not_possible_t/12.


:- was_dynamic int_not_possible_t/11.
:- shared_multifile int_not_possible_t/11.


:- was_dynamic int_possible_t/11.
:- shared_multifile int_possible_t/11.


:- was_dynamic not_possible_t/11.
:- shared_multifile not_possible_t/11.


:- was_dynamic int_not_possible_t/10.
:- shared_multifile int_not_possible_t/10.
...
:- shared_multifile int_possible_t/10.
...
:- shared_multifile not_possible_t/10.


:- was_dynamic int_not_possible_t/9.
:- shared_multifile int_not_possible_t/9.


:- was_dynamic int_possible_t/9.
:- shared_multifile int_possible_t/9.


:- was_dynamic not_possible_t/9.
:- shared_multifile not_possible_t/9.
...
:- shared_multifile int_not_possible_t/8.


:- was_dynamic int_possible_t/8.
:- shared_multifile int_possible_t/8.


:- was_dynamic not_possible_t/8.
:- shared_multifile not_possible_t/8.


:- was_dynamic int_not_possible_t/7.
:- shared_multifile int_not_possible_t/7.


:- was_dynamic int_possible_t/7.
:- shared_multifile int_possible_t/7.


:- was_dynamic not_possible_t/7.
:- shared_multifile not_possible_t/7.


:- was_dynamic int_not_assuming_t/13.
:- shared_multifile int_not_assuming_t/13.


:- was_dynamic int_assuming_t/13.
:- shared_multifile int_assuming_t/13.


:- was_dynamic not_assuming_t/13.
:- shared_multifile not_assuming_t/13.


:- was_dynamic int_not_assuming_t/12.
:- shared_multifile int_not_assuming_t/12.


:- was_dynamic int_assuming_t/12.
:- shared_multifile int_assuming_t/12.


:- was_dynamic not_assuming_t/12.
:- shared_multifile not_assuming_t/12.


:- was_dynamic int_not_assuming_t/11.
:- shared_multifile int_not_assuming_t/11.


:- was_dynamic int_assuming_t/11.
:- shared_multifile int_assuming_t/11.


:- was_dynamic not_assuming_t/11.
:- shared_multifile not_assuming_t/11.


:- was_dynamic int_not_assuming_t/10.
:- shared_multifile int_not_assuming_t/10.


:- was_dynamic int_assuming_t/10.
:- shared_multifile int_assuming_t/10.


:- was_dynamic not_assuming_t/10.
:- shared_multifile not_assuming_t/10.


:- was_dynamic int_not_assuming_t/9.
:- shared_multifile int_not_assuming_t/9.


:- was_dynamic int_assuming_t/9.
:- shared_multifile int_assuming_t/9.


:- was_dynamic not_assuming_t/9.
:- shared_multifile not_assuming_t/9.


:- was_dynamic int_not_assuming_t/8.
:- shared_multifile int_not_assuming_t/8.


:- was_dynamic int_assuming_t/8.
:- shared_multifile int_assuming_t/8.


:- was_dynamic not_assuming_t/8.
:- shared_multifile not_assuming_t/8.


:- was_dynamic int_not_assuming_t/7.
:- shared_multifile int_not_assuming_t/7.


:- was_dynamic int_assuming_t/7.
:- shared_multifile int_assuming_t/7.


:- was_dynamic not_assuming_t/7.
:- shared_multifile not_assuming_t/7.


:- was_dynamic int_not_answerable_t/13.
:- shared_multifile int_not_answerable_t/13.


:- was_dynamic int_answerable_t/13.
:- shared_multifile int_answerable_t/13.


:- was_dynamic not_answerable_t/13.
:- shared_multifile not_answerable_t/13.


:- was_dynamic int_not_answerable_t/12.
:- shared_multifile int_not_answerable_t/12.


:- was_dynamic int_answerable_t/12.
:- shared_multifile int_answerable_t/12.


:- was_dynamic not_answerable_t/12.
:- shared_multifile not_answerable_t/12.


:- was_dynamic int_not_answerable_t/11.
:- shared_multifile int_not_answerable_t/11.


:- was_dynamic int_answerable_t/11.
:- shared_multifile int_answerable_t/11.


:- was_dynamic not_answerable_t/11.
:- shared_multifile not_answerable_t/11.


:- was_dynamic int_not_answerable_t/10.
:- shared_multifile int_not_answerable_t/10.
...
:- shared_multifile int_answerable_t/10.


:- was_dynamic not_answerable_t/10.
:- shared_multifile not_answerable_t/10.


:- was_dynamic int_not_answerable_t/9.
:- shared_multifile int_not_answerable_t/9.


:- was_dynamic int_answerable_t/9.
:- shared_multifile int_answerable_t/9.


:- was_dynamic not_answerable_t/9.
:- shared_multifile not_answerable_t/9.
...
:- shared_multifile int_not_answerable_t/8.


:- was_dynamic int_answerable_t/8.
:- shared_multifile int_answerable_t/8.


:- was_dynamic not_answerable_t/8.
:- shared_multifile not_answerable_t/8.


:- was_dynamic int_not_answerable_t/7.
:- shared_multifile int_not_answerable_t/7.


:- was_dynamic int_answerable_t/7.
:- shared_multifile int_answerable_t/7.


:- was_dynamic not_answerable_t/7.
:- shared_multifile not_answerable_t/7.


:- was_dynamic int_fallacy_t/13.
:- shared_multifile int_fallacy_t/13.


:- was_dynamic askable_t/13.
:- shared_multifile askable_t/13.


:- was_dynamic int_fallacy_t/12.
:- shared_multifile int_fallacy_t/12.


:- was_dynamic askable_t/12.
:- shared_multifile askable_t/12.


:- was_dynamic int_fallacy_t/11.
:- shared_multifile int_fallacy_t/11.


:- was_dynamic askable_t/11.
:- shared_multifile askable_t/11.


:- was_dynamic int_fallacy_t/10.
:- shared_multifile int_fallacy_t/10.
...
:- shared_multifile askable_t/10.


:- was_dynamic int_fallacy_t/9.
:- shared_multifile int_fallacy_t/9.


:- was_dynamic askable_t/9.
:- shared_multifile askable_t/9.



:- was_dynamic int_fallacy_t/8.
:- shared_multifile int_fallacy_t/8.


:- was_dynamic askable_t/8.
:- shared_multifile askable_t/8.


:- was_dynamic int_fallacy_t/7.
:- shared_multifile int_fallacy_t/7.


:- was_dynamic askable_t/7.
:- shared_multifile askable_t/7.


:- was_dynamic int_not_askable_t/13.
:- shared_multifile int_not_askable_t/13.


:- was_dynamic int_askable_t/13.
:- shared_multifile int_askable_t/13.


:- was_dynamic not_askable_t/13.
:- shared_multifile not_askable_t/13.


:- was_dynamic int_not_askable_t/12.
:- shared_multifile int_not_askable_t/12.


:- was_dynamic int_askable_t/12.
:- shared_multifile int_askable_t/12.


:- was_dynamic not_askable_t/12.
:- shared_multifile not_askable_t/12.


:- was_dynamic int_not_askable_t/11.
:- shared_multifile int_not_askable_t/11.


:- was_dynamic int_askable_t/11.
:- shared_multifile int_askable_t/11.


:- was_dynamic not_askable_t/11.
:- shared_multifile not_askable_t/11.


:- was_dynamic int_not_askable_t/10.
:- shared_multifile int_not_askable_t/10.
...
:- shared_multifile int_askable_t/10.
...
:- shared_multifile not_askable_t/10.


:- was_dynamic int_not_askable_t/9.
:- shared_multifile int_not_askable_t/9.


:- was_dynamic int_askable_t/9.
:- shared_multifile int_askable_t/9.


:- was_dynamic not_askable_t/9.
:- shared_multifile not_askable_t/9.
...
:- shared_multifile int_not_askable_t/8.


:- was_dynamic int_askable_t/8.
:- shared_multifile int_askable_t/8.


:- was_dynamic not_askable_t/8.
:- shared_multifile not_askable_t/8.


:- was_dynamic int_not_askable_t/7.
:- shared_multifile int_not_askable_t/7.


:- was_dynamic int_askable_t/7.
:- shared_multifile int_askable_t/7.


:- was_dynamic not_askable_t/7.
:- shared_multifile not_askable_t/7.


:- was_dynamic int_not_asserted_t/13.
:- shared_multifile int_not_asserted_t/13.


:- was_dynamic int_asserted_t/13.
:- shared_multifile int_asserted_t/13.


:- was_dynamic not_asserted_t/13.
:- shared_multifile not_asserted_t/13.


:- was_dynamic int_not_asserted_t/12.
:- shared_multifile int_not_asserted_t/12.


:- was_dynamic int_asserted_t/12.
:- shared_multifile int_asserted_t/12.


:- was_dynamic not_asserted_t/12.
:- shared_multifile not_asserted_t/12.


:- was_dynamic int_not_asserted_t/11.
:- shared_multifile int_not_asserted_t/11.


:- was_dynamic int_asserted_t/11.
:- shared_multifile int_asserted_t/11.


:- was_dynamic not_asserted_t/11.
:- shared_multifile not_asserted_t/11.


:- was_dynamic int_not_asserted_t/10.
:- shared_multifile int_not_asserted_t/10.
...
:- shared_multifile int_asserted_t/10.


:- was_dynamic not_asserted_t/10.
:- shared_multifile not_asserted_t/10.


:- was_dynamic int_not_asserted_t/9.
:- shared_multifile int_not_asserted_t/9.


:- was_dynamic int_asserted_t/9.
:- shared_multifile int_asserted_t/9.


:- was_dynamic not_asserted_t/9.
:- shared_multifile not_asserted_t/9.
...
:- shared_multifile int_not_asserted_t/8.


:- was_dynamic int_asserted_t/8.
:- shared_multifile int_asserted_t/8.


:- was_dynamic not_asserted_t/8.
:- shared_multifile not_asserted_t/8.


:- was_dynamic int_not_asserted_t/7.
:- shared_multifile int_not_asserted_t/7.


:- was_dynamic int_asserted_t/7.
:- shared_multifile int_asserted_t/7.


:- was_dynamic not_asserted_t/7.
:- shared_multifile not_asserted_t/7.
...
:- shared_multifile int_not_assumed_t/13.


:- was_dynamic int_proven_t/13.
:- shared_multifile int_proven_t/13.


:- was_dynamic not_assumed_t/13.
:- shared_multifile not_assumed_t/13.


:- was_dynamic int_not_assumed_t/12.
:- shared_multifile int_not_assumed_t/12.


:- was_dynamic int_proven_t/12.
:- shared_multifile int_proven_t/12.


:- was_dynamic not_assumed_t/12.
:- shared_multifile not_assumed_t/12.


:- was_dynamic int_not_assumed_t/11.
:- shared_multifile int_not_assumed_t/11.


:- was_dynamic int_proven_t/11.
:- shared_multifile int_proven_t/11.


:- was_dynamic not_assumed_t/11.
:- shared_multifile not_assumed_t/11.


:- was_dynamic int_not_assumed_t/10.
:- shared_multifile int_not_assumed_t/10.
...
:- shared_multifile int_proven_t/10.
...
:- shared_multifile not_assumed_t/10.


:- was_dynamic int_not_assumed_t/9.
:- shared_multifile int_not_assumed_t/9.


:- was_dynamic int_proven_t/9.
:- shared_multifile int_proven_t/9.


:- was_dynamic not_assumed_t/9.
:- shared_multifile not_assumed_t/9.
...
:- shared_multifile int_not_assumed_t/8.


:- was_dynamic int_proven_t/8.
:- shared_multifile int_proven_t/8.


:- was_dynamic not_assumed_t/8.
:- shared_multifile not_assumed_t/8.


:- was_dynamic int_not_assumed_t/7.
:- shared_multifile int_not_assumed_t/7.


:- was_dynamic int_proven_t/7.
:- shared_multifile int_proven_t/7.


:- was_dynamic not_assumed_t/7.
:- shared_multifile not_assumed_t/7.


:- was_dynamic int_not_proven_not_t/13.
:- shared_multifile int_not_proven_not_t/13.


:- was_dynamic int_proven_not_t/13.
:- shared_multifile int_proven_not_t/13.


:- was_dynamic poss_t/13.
:- shared_multifile poss_t/13.


:- was_dynamic int_not_proven_not_t/12.
:- shared_multifile int_not_proven_not_t/12.


:- was_dynamic int_proven_not_t/12.
:- shared_multifile int_proven_not_t/12.


:- was_dynamic poss_t/12.
:- shared_multifile poss_t/12.


:- was_dynamic int_not_proven_not_t/11.
:- shared_multifile int_not_proven_not_t/11.


:- was_dynamic int_proven_not_t/11.
:- shared_multifile int_proven_not_t/11.


:- was_dynamic poss_t/11.
:- shared_multifile poss_t/11.


:- was_dynamic int_not_proven_not_t/10.
:- shared_multifile int_not_proven_not_t/10.
...
:- shared_multifile int_proven_not_t/10.
...
:- shared_multifile poss_t/10.


:- was_dynamic int_not_proven_not_t/9.
:- shared_multifile int_not_proven_not_t/9.


:- was_dynamic int_proven_not_t/9.
:- shared_multifile int_proven_not_t/9.


:- was_dynamic poss_t/9.
:- shared_multifile poss_t/9.
...
:- shared_multifile int_not_proven_not_t/8.


:- was_dynamic int_proven_not_t/8.
:- shared_multifile int_proven_not_t/8.


:- was_dynamic poss_t/8.
:- shared_multifile poss_t/8.


:- was_dynamic int_not_proven_not_t/7.
:- shared_multifile int_not_proven_not_t/7.


:- was_dynamic int_proven_not_t/7.
:- shared_multifile int_proven_not_t/7.


:- was_dynamic poss_t/7.
:- shared_multifile poss_t/7.


:- was_dynamic int_not_mudIsa/13.
:- shared_multifile int_not_mudIsa/13.


:- was_dynamic int_mudIsa/13.
:- shared_multifile int_mudIsa/13.


:- was_dynamic not_mudIsa/13.
:- shared_multifile not_mudIsa/13.


:- was_dynamic int_not_mudIsa/12.
:- shared_multifile int_not_mudIsa/12.


:- was_dynamic int_mudIsa/12.
:- shared_multifile int_mudIsa/12.


:- was_dynamic not_mudIsa/12.
:- shared_multifile not_mudIsa/12.


:- was_dynamic int_not_mudIsa/11.
:- shared_multifile int_not_mudIsa/11.


:- was_dynamic int_mudIsa/11.
:- shared_multifile int_mudIsa/11.


:- was_dynamic not_mudIsa/11.
:- shared_multifile not_mudIsa/11.


:- was_dynamic int_not_mudIsa/10.
:- shared_multifile int_not_mudIsa/10.


:- was_dynamic int_mudIsa/10.
:- shared_multifile int_mudIsa/10.


:- was_dynamic not_mudIsa/10.
:- shared_multifile not_mudIsa/10.


:- was_dynamic int_not_mudIsa/9.
:- shared_multifile int_not_mudIsa/9.


:- was_dynamic int_mudIsa/9.
:- shared_multifile int_mudIsa/9.


:- was_dynamic not_mudIsa/9.
:- shared_multifile not_mudIsa/9.


:- was_dynamic int_not_mudIsa/8.
:- shared_multifile int_not_mudIsa/8.


:- was_dynamic int_mudIsa/8.
:- shared_multifile int_mudIsa/8.


:- was_dynamic not_mudIsa/8.
:- shared_multifile not_mudIsa/8.


:- was_dynamic int_not_mudIsa/7.
:- shared_multifile int_not_mudIsa/7.


:- was_dynamic int_mudIsa/7.
:- shared_multifile int_mudIsa/7.


:- was_dynamic not_mudIsa/7.
:- shared_multifile not_mudIsa/7.


:- was_dynamic int_not_pred_isa_t/13.
:- shared_multifile int_not_pred_isa_t/13.


:- was_dynamic int_pred_isa_t/13.
:- shared_multifile int_pred_isa_t/13.


:- was_dynamic not_pred_isa_t/13.
:- shared_multifile not_pred_isa_t/13.


:- was_dynamic int_not_pred_isa_t/12.
:- shared_multifile int_not_pred_isa_t/12.


:- was_dynamic int_pred_isa_t/12.
:- shared_multifile int_pred_isa_t/12.


:- was_dynamic not_pred_isa_t/12.
:- shared_multifile not_pred_isa_t/12.


:- was_dynamic int_not_pred_isa_t/11.
:- shared_multifile int_not_pred_isa_t/11.


:- was_dynamic int_pred_isa_t/11.
:- shared_multifile int_pred_isa_t/11.


:- was_dynamic not_pred_isa_t/11.
:- shared_multifile not_pred_isa_t/11.


:- was_dynamic int_not_pred_isa_t/10.
:- shared_multifile int_not_pred_isa_t/10.


:- was_dynamic int_pred_isa_t/10.
:- shared_multifile int_pred_isa_t/10.


:- was_dynamic not_pred_isa_t/10.
:- shared_multifile not_pred_isa_t/10.


:- was_dynamic int_not_pred_isa_t/9.
:- shared_multifile int_not_pred_isa_t/9.


:- was_dynamic int_pred_isa_t/9.
:- shared_multifile int_pred_isa_t/9.


:- was_dynamic not_pred_isa_t/9.
:- shared_multifile not_pred_isa_t/9.


:- was_dynamic int_not_pred_isa_t/8.
:- shared_multifile int_not_pred_isa_t/8.


:- was_dynamic int_pred_isa_t/8.
:- shared_multifile int_pred_isa_t/8.


:- was_dynamic not_pred_isa_t/8.
:- shared_multifile not_pred_isa_t/8.


:- was_dynamic int_not_pred_isa_t/7.
:- shared_multifile int_not_pred_isa_t/7.


:- was_dynamic int_pred_isa_t/7.
:- shared_multifile int_pred_isa_t/7.


:- was_dynamic not_pred_isa_t/7.
:- shared_multifile not_pred_isa_t/7.


:- was_dynamic int_not_pred_t/13.
:- shared_multifile int_not_pred_t/13.


:- was_dynamic int_pred_t/13.
:- shared_multifile int_pred_t/13.


:- was_dynamic not_pred_t/13.
:- shared_multifile not_pred_t/13.


:- was_dynamic int_not_pred_t/12.
:- shared_multifile int_not_pred_t/12.


:- was_dynamic int_pred_t/12.
:- shared_multifile int_pred_t/12.


:- was_dynamic not_pred_t/12.
:- shared_multifile not_pred_t/12.


:- was_dynamic int_not_pred_t/11.
:- shared_multifile int_not_pred_t/11.


:- was_dynamic int_pred_t/11.
:- shared_multifile int_pred_t/11.


:- was_dynamic not_pred_t/11.
:- shared_multifile not_pred_t/11.
...
:- shared_multifile not_pred_t/10.


:- was_dynamic int_not_pred_t/9.
:- shared_multifile int_not_pred_t/9.


:- was_dynamic int_pred_t/9.
:- shared_multifile int_pred_t/9.


:- was_dynamic not_pred_t/9.
:- shared_multifile not_pred_t/9.


:- was_dynamic int_not_pred_t/8.
:- shared_multifile int_not_pred_t/8.


:- was_dynamic int_pred_t/8.
:- shared_multifile int_pred_t/8.


:- was_dynamic not_pred_t/8.
:- shared_multifile not_pred_t/8.


:- was_dynamic int_not_pred_t/7.
:- shared_multifile int_not_pred_t/7.


:- was_dynamic int_pred_t/7.
:- shared_multifile int_pred_t/7.


:- was_dynamic not_pred_t/7.
:- shared_multifile not_pred_t/7.


:- was_dynamic int_not_either_t/13.
:- shared_multifile int_not_either_t/13.


:- was_dynamic int_either_t/13.
:- shared_multifile int_either_t/13.


:- was_dynamic not_either_t/13.
:- shared_multifile not_either_t/13.


:- was_dynamic int_not_either_t/12.
:- shared_multifile int_not_either_t/12.


:- was_dynamic int_either_t/12.
:- shared_multifile int_either_t/12.


:- was_dynamic not_either_t/12.
:- shared_multifile not_either_t/12.


:- was_dynamic int_not_either_t/11.
:- shared_multifile int_not_either_t/11.


:- was_dynamic int_either_t/11.
:- shared_multifile int_either_t/11.


:- was_dynamic not_either_t/11.
:- shared_multifile not_either_t/11.


:- was_dynamic int_not_either_t/10.
:- shared_multifile int_not_either_t/10.


:- was_dynamic int_either_t/10.
:- shared_multifile int_either_t/10.


:- was_dynamic not_either_t/10.
:- shared_multifile not_either_t/10.


:- was_dynamic int_not_either_t/9.
:- shared_multifile int_not_either_t/9.


:- was_dynamic int_either_t/9.
:- shared_multifile int_either_t/9.


:- was_dynamic not_either_t/9.
:- shared_multifile not_either_t/9.


:- was_dynamic int_not_either_t/8.
:- shared_multifile int_not_either_t/8.


:- was_dynamic int_either_t/8.
:- shared_multifile int_either_t/8.


:- was_dynamic not_either_t/8.
:- shared_multifile not_either_t/8.


:- was_dynamic int_not_either_t/7.
:- shared_multifile int_not_either_t/7.


:- was_dynamic int_either_t/7.
:- shared_multifile int_either_t/7.


:- was_dynamic not_either_t/7.
:- shared_multifile not_either_t/7.


:- was_dynamic int_not_both_t/13.
:- shared_multifile int_not_both_t/13.


:- was_dynamic int_both_t/13.
:- shared_multifile int_both_t/13.


:- was_dynamic not_both_t/13.
:- shared_multifile not_both_t/13.


:- was_dynamic int_not_both_t/12.
:- shared_multifile int_not_both_t/12.


:- was_dynamic int_both_t/12.
:- shared_multifile int_both_t/12.


:- was_dynamic not_both_t/12.
:- shared_multifile not_both_t/12.


:- was_dynamic int_not_both_t/11.
:- shared_multifile int_not_both_t/11.


:- was_dynamic int_both_t/11.
:- shared_multifile int_both_t/11.


:- was_dynamic not_both_t/11.
:- shared_multifile not_both_t/11.


:- was_dynamic int_not_both_t/10.
:- shared_multifile int_not_both_t/10.


:- was_dynamic int_both_t/10.
:- shared_multifile int_both_t/10.


:- was_dynamic not_both_t/10.
:- shared_multifile not_both_t/10.


:- was_dynamic int_not_both_t/9.
:- shared_multifile int_not_both_t/9.
...
:- shared_multifile int_both_t/9.


:- was_dynamic not_both_t/9.
:- shared_multifile not_both_t/9.


:- was_dynamic int_not_both_t/8.
:- shared_multifile int_not_both_t/8.


:- was_dynamic int_both_t/8.
:- shared_multifile int_both_t/8.


:- was_dynamic not_both_t/8.
:- shared_multifile not_both_t/8.
...
:- shared_multifile int_not_both_t/7.


:- was_dynamic int_both_t/7.
:- shared_multifile int_both_t/7.


:- was_dynamic not_both_t/7.
:- shared_multifile not_both_t/7.
