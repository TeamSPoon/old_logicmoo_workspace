...
:- assert_kif("(documentation immediateInstance EnglishLanguage \"An object is an &%immediateInstance of a &%SetOrClass if it is an instance of the &%SetOrClass and it is not an instance of a proper genls of &%SetOrClass.\")").
:- assert_kif("(=> (immediateInstance ?ENTITY ?CLASS) (not (exists (?SUBCLASS) (and (genls ?SUBCLASS ?CLASS) (not (equal ?SUBCLASS ?CLASS)) (instance ?ENTITY ?SUBCLASS)))))").
...
:- assert_kif("(documentation genls EnglishLanguage \"(&%genls ?CLASS1 ?CLASS2) means that ?CLASS1 is a genls of ?CLASS2, i.e. every instance of ?CLASS1 is also an instance of ?CLASS2. A class may have multiple superclasses and subclasses.\")").
:- assert_kif("(=> (genls ?X ?Y) (and (instance ?X SetOrClass) (instance ?Y SetOrClass)))").
:- assert_kif("(=> (and (genls ?X ?Y) (instance ?Z ?X)) (instance ?Z ?Y))").
...
:- assert_kif("(documentation immediateSubclass EnglishLanguage \"A &%SetOrClass ?CLASS1 is an &%immediateSubclass of another &%SetOrClass ?CLASS2 just in case ?CLASS1 is a genls of ?CLASS2 and there is no other genls of ?CLASS2 such that ?CLASS1 is also a genls of it.\")").
...
:- assert_kif("(documentation domainSubclass EnglishLanguage \"&%Predicate used to specify argument type restrictions of &%Predicates. The formula (&%domainSubclass ?REL ?INT ?CLASS) means that the ?INT'th element of each tuple in the relation ?REL must be a genls of ?CLASS.\")").
...
:- assert_kif("(documentation partition EnglishLanguage \"A &%partition of a class C is a set of mutually &%disjoint classes (a genls partition) which covers C. Every instance of C is an instance of exactly one of the subclasses in the partition.\")").
...
:- assert_kif("(genls OrganicThing SelfConnectedObject)").
...
:- assert_kif("(genls SyntheticSubstance Substance)").
...
:- assert_kif("(genls NaturalSubstance Substance)").
...
:- assert_kif("(genls ContentBearingPhysical Physical)").
...
:- assert_kif("(genls ContentBearingProcess ContentBearingPhysical)").
% :- assert_kif("; NS: add. Missing!").
:- assert_kif("(genls ContentBearingProcess Process)").
% :- assert_kif("; NS: cf. Note that &%ManualHumanLanguage is not a genls of &%Process, despite the documentation statement below.").
...
:- assert_kif("(genls ContentBearingObject ContentBearingPhysical)").
...
:- assert_kif("(documentation Character EnglishLanguage \"An element of an alphabet, a set of numerals, etc. Note that a &%Character may or may not be part of a &%Language. &%Character is a genls of &%SymbolicString, because every instance of &%Character is an alphanumeric sequence consisting of a single element.\")").
...
:- assert_kif("(genls Icon ContentBearingPhysical)").
:- assert_kif("(documentation Icon EnglishLanguage \"This is the genls of &%ContentBearingPhysical which are not part of a &%Language and which have some sort of similarity with the &%Objects that they represent. This &%Class would include symbolic roadway signs, representational art works, photographs, etc.\")").
...
:- assert_kif("(genls LinguisticExpression ContentBearingPhysical)").
:- assert_kif("(disjoint LinguisticExpression Icon)").
:- assert_kif("(documentation LinguisticExpression EnglishLanguage \"This is the genls of &%ContentBearingPhysical which are language-related. Note that this &%Class encompasses both &%Language and the the elements of &%Languages, e.g. &%Words.\")").
...
:- assert_kif("(documentation AnimalLanguage EnglishLanguage \"The &%genls of &%Languages used by &%Animals other than &%Humans.\")").
...
:- assert_kif("(documentation ArtificialLanguage EnglishLanguage \"The &%genls of &%Languages that are designed by &%Humans.\")").
...
:- assert_kif("(documentation HumanLanguage EnglishLanguage \"The &%genls of &%Languages used by &%Humans.\")").
...
:- assert_kif("(documentation NaturalLanguage EnglishLanguage \"The &%genls of &%HumanLanguages which are not designed and which evolve from generation to generation. This &%Class includes all of the national languages, e.g. English, Spanish, Japanese, etc. Note that this class includes dialects of natural languages.\")").
...
% :- assert_kif("; NS: add.").
:- assert_kif("(documentation CognitiveAgent EnglishLanguage \"A &%CognitiveAgent is an &%Agent that has the ability to reason, deliberate, make plans, and experience emotions. Although &%Human is a genls of &%CognitiveAgent, there may be instances of &%CognitiveAgent which are not also instances of &%Human. For example, &%Primates, dolphins, whales, and some extraterrestrials (if they exist) might be considered &%CognitiveAgents.\")").
...
:- assert_kif("(genls LegalAgent Agent)").
% :- assert_kif("; NS: add.").
...
:- assert_kif("(genls SingleAgentProcess Process)").
...
:- assert_kif("(genls PhysicalAttribute InternalAttribute)").
...
:- assert_kif("(documentation UnaryConstantFunctionQuantity EnglishLanguage \"A &%genls of &%FunctionQuantity, instances of which are returned by &%UnaryFunctions that map from one instance of the &%Class &%ConstantQuantity to another instance of the &%Class &%ConstantQuantity.\")").
...
:- assert_kif("(genls SingleValuedRelation InheritableRelation)").
...
:- assert_kif("(genls TotalValuedRelation InheritableRelation)").
...
:- assert_kif("(genls BinaryRelation InheritableRelation)").
...
:- assert_kif("(genls CaseRole InheritableRelation)").
...
:- assert_kif("(genls InheritableRelation Relation)").
...
:- assert_kif("(genls ProbabilityRelation InheritableRelation)").
...
:- assert_kif("(genls SpatialRelation InheritableRelation)").
...
:- assert_kif("(genls TemporalRelation InheritableRelation)").
...
:- assert_kif("(genls IntentionalRelation InheritableRelation)").
:- assert_kif("(genls IntentionalRelation Relation)").
...
:- assert_kif("(genls PropositionalAttitude InheritableRelation)").
...
:- assert_kif("(genls ObjectAttitude InheritableRelation)").
...
:- assert_kif("(genls TernaryRelation InheritableRelation)").
...
:- assert_kif("(genls QuaternaryRelation InheritableRelation)").
...
:- assert_kif("(genls QuintaryRelation InheritableRelation)").
...
:- assert_kif("(=> (and (domainSubclass ?REL ?NUMBER ?CLASS) (instance ?REL Predicate) (?REL @ROW)) (genls (ListOrderFn (ListFn @ROW) ?NUMBER) ?CLASS))").
...
:- assert_kif("(genls Predicate InheritableRelation)").
...
:- assert_kif("(genls Function InheritableRelation)").
...
:- assert_kif("(genls UnaryFunction InheritableRelation)").
...
:- assert_kif("(documentation SequenceFunction EnglishLanguage \"The &%Class of &%OneToOneFunctions whose range is a genls of the &%PositiveIntegers.\")").
...
:- assert_kif("(genls BinaryFunction InheritableRelation)").
...
:- assert_kif("(genls TernaryFunction InheritableRelation)").
...
:- assert_kif("(genls QuaternaryFunction InheritableRelation)").
...
:- assert_kif("(genls BinaryPredicate InheritableRelation)").
...
:- assert_kif("(genls TernaryPredicate InheritableRelation)").
...
:- assert_kif("(genls QuaternaryPredicate InheritableRelation)").
...
:- assert_kif("(genls QuintaryPredicate InheritableRelation)").
...
:- assert_kif("(genls RelationExtendedToQuantities InheritableRelation)").
...
:- assert_kif("(documentation causesSubclass EnglishLanguage \"The causation relation between subclasses of &%Process.  (&%causesSubclass ?PROCESS1 ?PROCESS2) means that the genls of &%Process ?PROCESS1 brings about the genls of &%Process ?PROCESS2, e.g. (&%causesSubclass &%Killing &%Death).\")").
...
:- assert_kif("(=> (and (instance ?ROLE CaseRole) (?ROLE ?ARG1 ?ARG2) (instance ?ARG1 ?PROC) (genls ?PROC Process)) (capability ?PROC ?ROLE ?ARG2))").
...
:- assert_kif("(genls Tree DirectedGraph)").
...
:- assert_kif("(genls PhysicalSystem Physical)").
...
:- assert_kif("(genls CompositeUnitOfMeasure UnitOfMeasure)").
...
:- assert_kif("(genls NonCompositeUnitOfMeasure UnitOfMeasure)").
...
:- assert_kif("(documentation LengthMeasure EnglishLanguage \"A &%genls of &%ConstantQuantity, instances of which are measures of length.\")").
:- assert_kif("(genls UnitOfLength NonCompositeUnitOfMeasure)").
...
:- assert_kif("(documentation MassMeasure EnglishLanguage \"A &%genls of &%ConstantQuantity, instances of which are measures of the amount of matter in an &%Object.\")").
:- assert_kif("(genls UnitOfMass NonCompositeUnitOfMeasure)").
...
:- assert_kif("(genls UnitOfTemperature NonCompositeUnitOfMeasure)").
...
:- assert_kif("(documentation CurrencyMeasure EnglishLanguage \"Instances of this &%genls of &%ConstantQuantity are measures of &%monetaryValue stated in terms of some &%UnitOfCurrency such as &%UnitedStatesDollar, &%UnitedStatesCent, Lire, Yen, etc.\")").
:- assert_kif("(genls UnitOfCurrency NonCompositeUnitOfMeasure)").
...
:- assert_kif("(genls UnitOfAngularMeasure NonCompositeUnitOfMeasure)").
...
:- assert_kif("(genls UnitOfInformation NonCompositeUnitOfMeasure)").
...
:- assert_kif("(genls UnitOfDuration NonCompositeUnitOfMeasure)").
:- assert_kif("(documentation UnitOfDuration EnglishLanguage \"Every instance of this &%Class is a &%UnitOfMeasure that can be used with &%MeasureFn to form instances of &%TimeDuration. Note that &%TimeDuration is a &%genls of &%TimeMeasure.\")").
...
:- assert_kif("(genls UnitOfMeasureMultiplier UnaryFunction)").
:- assert_kif("(genls UnitOfMeasureMultiplier TotalValuedRelation)").
...
:- assert_kif("(documentation IntervalFn EnglishLanguage \"A &%BinaryFunction that maps two instances of &%ConstantQuantity to the &%genls of &%ConstantQuantity that comprises the interval from the first &%ConstantQuantity to the second &%ConstantQuantity. For example, (&%IntervalFn (&%MeasureFn 8 &%Meter) (&%MeasureFn 14 &%Meter)) would return the &%genls of &%ConstantQuantity comprising quantities between 8 and 14 meters in length.\")").
...
:- assert_kif("(genls FrequencyMeasure TimeDependentQuantity)").
:- assert_kif("(documentation FrequencyMeasure EnglishLanguage \"A &%genls of &%TimeDependentQuantity, instances of which are measures of the frequency with which some &%Process occurs.\")").
:- assert_kif("(genls UnitOfFrequency CompositeUnitOfMeasure)").
...
:- assert_kif("(genls Oval ClosedTwoDimensionalFigure)").
...
:- assert_kif("(genls UnitOfAtmosphericPressure CompositeUnitOfMeasure)").
...
:- assert_kif("(documentation DayFn EnglishLanguage \"A &%BinaryFunction that assigns a &%PositiveRealNumber and a genls of &%Months to the &%Days within each &%Month corresponding to that &%PositiveRealNumber. For example, (&%DayFn 16 &%August) is the &%Class of all sixteenth days of August. For another example, (&%DayFn 9 &%Month) would return the class of all ninth days of any month. For still another example, (&%DayFn 18 (&%MonthFn &%August (&%YearFn 1912))) denotes the 18th day of August 1912.\")").
...
:- assert_kif("(documentation SecondFn EnglishLanguage \"A &%BinaryFunction that assigns a &%PositiveRealNumber and a genls of &%Minutes to the &%Seconds within each &%Minute corresponding to that &%PositiveRealNumber. For example, (&%SecondFn 4 (&%MinuteFn 5 &%Hour)) is the &%Class of all fourth &%Seconds of every fifth &%Minute of every hour. For another example, (&%SecondFn 8 &%Minute) would return the eighth second of every minute. For still another example, (&%SecondFn 9 (&%MinuteFn 15 (&%HourFn 14 (&%DayFn 18 (&%MonthFn &%August (&%YearFn 1912)))))) denotes 9 seconds and 15 minutes after 2 PM on the 18th day of August 1912.\")").
...
:- assert_kif("(genls Wednesday Day)").
...
:- assert_kif("(genls AutonomicProcess PhysiologicProcess)").
...
:- assert_kif("(genls OrganOrTissueProcess AutonomicProcess)").
...
:- assert_kif("(genls Breathing AutonomicProcess)").
...
:- assert_kif("(genls Digesting AutonomicProcess)").
...
:- assert_kif("(genls Growth AutonomicProcess)").
...
:- assert_kif("(documentation Injuring EnglishLanguage \"The process of creating a traumatic wound or injury. Since &%Injuring is not possible without some biologic function of the organism being injured, it is a genls of &%BiologicalProcess.\")").
...
:- assert_kif("(documentation Poisoning EnglishLanguage \"A &%Poisoning is caused by an external substance. Since &%Poisoning is not possible without some biologic function which affects the &%Organism being injured, it is a genls of &%BiologicalProcess.\")").
...
:- assert_kif("(genls NaturalProcess Process)").
...
:- assert_kif("(genls LegalDecision JudicialProcess)").
...
:- assert_kif("(genls MilitaryProcess OrganizationalProcess)").
...
:- assert_kif("(genls VocalCords Organ)").
...
% :- assert_kif("; KJN: Deleting. Fixed Music ontology and replacing it with concepts from that. (genls Singing Speaking) (genls Singing Music) (documentation Singing EnglishLanguage \"&%Speaking that is also &%Music.\")").
...
:- assert_kif("(genls GeologicalProcess InternalChange)").
...
:- assert_kif("(genls WeatherProcess Motion)").
...
:- assert_kif("(documentation Impelling EnglishLanguage \"The &%genls of &%Transfer where the &%patient travels through space by means of a sudden, forceful event. Some examples would be shooting, throwing, tossing, etc.\")").
:- assert_kif("(genls Shooting Impelling)").
:- assert_kif("(documentation Shooting EnglishLanguage \"The &%genls of &%Impelling where the &%patient is a projectile that is fired through the air by means of some sort of &%Device.\")").
...
:- assert_kif("(genls Grabbing Attaching)").
...
:- assert_kif("(genls Driving Guiding)").
...
:- assert_kif("(documentation Giving EnglishLanguage \"The &%genls of &%ChangeOfPossession where the &%agent gives the &%destination something.\")").
...
:- assert_kif("(documentation Lending EnglishLanguage \"The &%genls of &%Giving &%Processes where the &%agent gives the &%destination something for a limited period of time with the expectation that it will be returned later (perhaps with interest).\")").
...
:- assert_kif("(documentation Getting EnglishLanguage \"The &%genls of &%ChangeOfPossession where the &%agent gets something. Note that the source from which something is obtained is specified with the &%origin &%CaseRole.\")").
...
:- assert_kif("(documentation Borrowing EnglishLanguage \"The &%genls of &%Getting &%Processes where the &%agent gets something for a limited period of time with the expectation that it will be returned later (perhaps with interest).\")").
:- assert_kif("(genls Transaction ChangeOfPossession)").
:- assert_kif("(genls Transaction DualObjectProcess)").
:- assert_kif("(documentation Transaction EnglishLanguage \"The &%genls of &%ChangeOfPossession where something is exchanged for something else.\")").
...
:- assert_kif("(genls ServiceProcess SocialInteraction)").
...
:- assert_kif("(genls CommercialService ServiceProcess)").
...
:- assert_kif("(documentation Deciding EnglishLanguage \"The genls of &%Selecting where the &%agent opts for one course of action out of a set of multiple possibilities that are open to him/her.\")").
...
:- assert_kif("(genls Voting Deciding)").
...
:- assert_kif("(genls Judging Selecting)").
:- assert_kif("(documentation Judging EnglishLanguage \"The genls of &%Selecting where the &%agent opts for one belief out of a set of multiple possibilities that are available to him/her.\")").
...
:- assert_kif("(documentation Destruction EnglishLanguage \"The &%genls of &%Damagings in which the &%patient (or an essential element of the &%patient) is destroyed. Note that the difference between this concept and its superclass is solely one of extent.\")").
...
:- assert_kif("(documentation Killing EnglishLanguage \"The &%genls of &%Destruction in which the death of an &%Organism is caused by an &%Organism. Note that in cases of suicide the &%Organism would be the same in both cases.\")").
...
:- assert_kif("(documentation Cutting EnglishLanguage \"The &%genls of &%Poking &%Processes which involve a sharp &%instrument.\")").
...
:- assert_kif("(genls Ungrasping Detaching)").
...
:- assert_kif("(documentation Coloring EnglishLanguage \"The &%genls of &%SurfaceChange where a &%ColorAttribute of the &%patient is altered. Note that the change in color may apply to just part of the object.\")").
...
:- assert_kif("(documentation ContentDevelopment EnglishLanguage \"A &%genls of &%IntentionalProcess in which content is modified, its form is altered or it is created anew.\")").
...
:- assert_kif("(documentation Reading EnglishLanguage \"A &%genls of &%ContentDevelopment in which content is converted from a written form into a spoken representation. Note that the class &%Interpreting should be used in cases where a &%Text is read silently.\")").
...
:- assert_kif("(documentation Writing EnglishLanguage \"A &%genls of &%ContentDevelopment in which content is converted from one form (e.g. uttered, written or represented mentally) into a written form. Note that this class covers both transcription and original creation of written &%Texts.\")").
...
:- assert_kif("(documentation Creation EnglishLanguage \"The &%genls of &%Process in which something is created. Note that the thing created is specified with the &%result &%CaseRole.\")").
...
:- assert_kif("(documentation Making EnglishLanguage \"The &%genls of &%Creation in which an individual &%Artifact or a type of &%Artifact is made.\")").
:- assert_kif("(genls Constructing Making)").
:- assert_kif("(documentation Constructing EnglishLanguage \"The &%genls of &%Making in which a &%StationaryArtifact is built.\")").
...
:- assert_kif("(documentation SocialInteraction EnglishLanguage \"The &%genls of &%IntentionalProcess that involves interactions between &%CognitiveAgents.\")").
...
:- assert_kif("(genls Communication SocialInteraction)").
:- assert_kif("(genls Communication ContentBearingProcess)").
...
:- assert_kif("(genls Disseminating Communication)").
...
:- assert_kif("(genls Gesture Communication)").
...
:- assert_kif("(genls Expressing Communication)").
:- assert_kif("(documentation Expressing EnglishLanguage \"Instances of this &%Class express a state of the &%agent. For example, Jane thanked Barbara for the present she had given her. The thanking in this case expresses the gratitude of Jane towards Barbara. Note that &%Expressing, unlike the other speech act types, is not a genls of &%LinguisticCommunication. This is because emotions, for example, can be expressed without language, e.g. by smiling.\")").
...
:- assert_kif("(genls LinguisticCommunication Communication)").
...
:- assert_kif("(genls Disagreeing Stating)").
...
:- assert_kif("(documentation Offering EnglishLanguage \"The genls of &%Committing in which a &%CognitiveAgent offers something &%Physical to another agent. Offerings may be unconditional (in which case they are a promise to effect a &%UnilateralGiving) or conditional (in which case they are a promise to effect a &%Transaction of some sort).\")").
...
:- assert_kif("(documentation Cooperation EnglishLanguage \"The &%genls of &%SocialInteraction where the participants involved work together for the achievement of a common goal.\")").
...
:- assert_kif("(documentation Seeing EnglishLanguage \"The &%genls of &%Perception in which the sensing is done by an ocular &%Organ.\")").
...
:- assert_kif("(documentation Smelling EnglishLanguage \"The &%genls of &%Perception in which the sensing is done by an olefactory &%Organ.\")").
...
:- assert_kif("(documentation Tasting EnglishLanguage \"The &%genls of &%Perception in which the sensing is done by of an &%Organ which can discriminate various tastes.\")").
...
:- assert_kif("(documentation Hearing EnglishLanguage \"The &%genls of &%Perception in which the sensing is done by an auditory &%Organ.\")").
...
:- assert_kif("(genls SoundAttribute RelationalAttribute)").
...
:- assert_kif("(genls RadiatingLight RadiatingElectromagnetic)").
:- assert_kif("(documentation RadiatingLight EnglishLanguage \"The &%genls of &%Radiating in which light is given off or absorbed. Some examples include blinking, flashing, and glittering.\")").
...
:- assert_kif("(genls RadiatingInfrared RadiatingElectromagnetic)").
:- assert_kif("(genls RadiatingXRay RadiatingElectromagnetic)").
:- assert_kif("(genls RadiatingSound Radiating)").
:- assert_kif("(documentation RadiatingSound EnglishLanguage \"The &%genls of &%Radiating in which sound waves are given off or absorbed. Some examples include creaking, roaring, and whistling.\")").
...
% :- assert_kif("; KJN: Removing this and renaming it to MakingMusic to be consistent with the Verb form of most Processes (genls Music RadiatingSound) (documentation Music EnglishLanguage \"The &%genls of &%RadiatingSound where the sound is intended to be melodic and is produced deliberately.\")").
:- assert_kif("(genls MakingMusic RadiatingSound)").
...
:- assert_kif("(genls MakingInstrumentalMusic MakingMusic)").
...
:- assert_kif("(genls MakingVocalMusic MakingMusic)").
:- assert_kif("(genls MakingVocalMusic Vocalizing)").
...
:- assert_kif("(genls Singing MakingVocalMusic)").
...
:- assert_kif("(documentation RadiatingElectromagnetic EnglishLanguage \"&%RadiatingElectromagnetic is the genls of &%Radiating processes in which electromagnetic radiation is transmitted or absorbed.\")").
...
:- assert_kif("(=> (and (instance ?X ?Y) (genls ?Y PureSubstance) (barometricPressure ?X (MeasureFn ?PRES InchMercury)) (greaterThan 29.92 ?PRES) (boilingPoint ?Y (MeasureFn ?BOIL KelvinDegree)) (measure ?X (MeasureFn ?TEMP KelvinDegree)) (greaterThan ?TEMP ?BOIL)) (attribute ?X Gas))").
:- assert_kif("(=> (and (instance ?X ?Y) (genls ?Y PureSubstance) (boilingPoint ?Y (MeasureFn ?BOIL KelvinDegree)) (meltingPoint ?Y (MeasureFn ?MELT KelvinDegree)) (measure ?X (MeasureFn ?TEMP KelvinDegree)) (greaterThan ?TEMP ?MELT) (lessThan ?TEMP ?BOIL)) (attribute ?X Liquid))").
:- assert_kif("(=> (and (instance ?X ?Y) (genls ?Y PureSubstance) (meltingPoint ?Y (MeasureFn ?MELT KelvinDegree)) (barometricPressure ?X (MeasureFn ?PRES InchMercury)) (greaterThan ?PRES 29.92) (measure ?X (MeasureFn ?TEMP KelvinDegree)) (lessThan ?TEMP ?MELT)) (attribute ?X Solid))").
...
:- assert_kif("(genls Evaporating StateChange)").
...
:- assert_kif("(genls AstronomicalBody Object)").
...
:- assert_kif("(genls LocalizablePlace GeographicArea)").
...
% :- assert_kif("(genls IndependentState Nation) (=> (geopoliticalSubdivision ?SUB ?AREA) (not (instance ?SUB IndependentState)))").
% :- assert_kif("; It would be best to rewrite all rules in which &%Nation is used in the sense of &%IndependentState so that they use &%IndependentState. This would allow &%Nation to be interpreted in a more general \"cultural\" or \"homeland\" sense, as suggested by (genls IndependentState Nation). England, Scotland, Wales, and NorthernIreland, for example, would be &%Nations, but not (currently) &%IndependentStates.").
...
% :- assert_kif("; KJN: Moving this to MILO to remove dependencies (genls StreamWaterArea WaterArea) (disjoint StreamWaterArea StaticWaterArea) (documentation StreamWaterArea EnglishLanguage \"A relatively narrow &%WaterArea where the water flows constantly and in the same direction, e.g. a river, a stream, etc.\")").
% :- assert_kif(" (genls StaticWaterArea WaterArea) (documentation StaticWaterArea EnglishLanguage \"A &%WaterArea in which water does not flow constantly or in the same direction, e.g. most lakes and ponds.\")").
...
:- assert_kif("(documentation LandTransitway EnglishLanguage \"&%LandTransitway is the genls of &%Transitway that represents areas intended for motion over the ground.\")").
...
:- assert_kif("(genls Mineral Substance)").
...
:- assert_kif("(genls OrganicObject OrganicThing)").
...
:- assert_kif("(genls Fungus Organism)").
...
:- assert_kif("(genls LiquidMixture Mixture)").
...
:- assert_kif("(genls Solution LiquidMixture)").
...
:- assert_kif("(genls Suspension LiquidMixture)").
...
:- assert_kif("(genls Air GasMixture)").
...
:- assert_kif("(genls BodySubstance Substance)").
...
:- assert_kif("(genls Meat SelfConnectedObject)").
...
% :- assert_kif("; KJN: Moving this to Mid-level-ontology.kif as it is causing dependency errors. (genls Beverage Substance) (disjoint Meat Beverage) (documentation Beverage EnglishLanguage \"Any food that is ingested by &%Drinking. Note that this class is disjoint &%Meat and &%FruitOrVegetable.\")").
...
% :- assert_kif("; KJN: This is moved from Economy.kif. Seed being subclassed from FruitOrVegetable seems incorrect, though, as FruitOrVegetable talks about a ripened Reproductive Body (although no formal rule states it) while a seed may not necessarily be so. commenting it out for now. (genls Seed FruitOrVegetable)").
...
:- assert_kif("(documentation FruitOrVegetable EnglishLanguage \"Any fruit or vegetable, i.e. a ripened &%ReproductiveBody of a &%Plant. Note that &%FruitOrVegetable is not a genls of &%Food, because some fruits, e.g. poisonous berries, are not edible.\")").
...
:- assert_kif("(genls BodyCavity BodyPart)").
...
:- assert_kif("(genls BodyVessel BodyCavity)").
...
:- assert_kif("(genls Bone AnimalSubstance)").
...
:- assert_kif("(genls Muscle AnimalSubstance)").
...
:- assert_kif("(genls ParticleWord Word)").
...
:- assert_kif("(genls Text ContentBearingObject)").
...
% :- assert_kif("; NS: add.").
:- assert_kif("(=> (and (instance ?TEXT ?CLASS) (genls ?CLASS FactualText) (authors ?AGENT ?CLASS) (subsumesContentInstance ?TEXT ?CONTENT) (instance ?CONTENT Formula)) (believes ?AGENT ?CONTENT))").
...
% :- assert_kif("; NS: add.").
:- assert_kif("(=> (and (instance ?TEXT ?CLASS) (genls ?CLASS FictionalText) (authors ?AGENT ?CLASS)) (exists (?CONTENT) (and (subsumesContentInstance ?TEXT ?CONTENT) (instance ?CONTENT Formula) (not (believes ?AGENT ?CONTENT)))))").
...
% :- assert_kif("; KJN: Moving to MILO (genls Series Text) (documentation Series EnglishLanguage \"A &%Text consisting of multiple self-contained units. Some examples are an encyclopedia containing a couple dozen volumes, a television series made up of many episodes, a film serial, etc.\")").
...
% :- assert_kif(" (genls Periodical Series) (documentation Periodical EnglishLanguage \"A &%Series whose elements are published separately and on a periodic basis.\")").
% :- assert_kif(" (genls Article Text) (disjoint Article Book) (documentation Article EnglishLanguage \"A relatively short &%Text that either is unbound or is bound with other &%Articles in a &%Book.\")").
...
:- assert_kif("(genls Artifact Object)").
...
% :- assert_kif("; Moved hotel definition to Hotel.kif. (genls Hotel ResidentialBuilding) (genls Hotel TemporaryResidence) (genls Hotel CommercialAgent) (documentation Hotel EnglishLanguage \"A &%ResidentialBuilding which provides temporary accommodations to guests in exchange for money.\")").
...
:- assert_kif("(genls WearableItem Artifact)").
:- assert_kif("(documentation WearableItem EnglishLanguage \"&%WearableItem is the genls of &%Artifacts that are made to be worn on the body.\")").
:- assert_kif("(=> (instance ?WI WearableItem) (hasPurpose ?WI (exists (?H) (and (instance ?H Human) (wears ?H ?WI)))))").
:- assert_kif("(genls Clothing WearableItem)").
...
:- assert_kif("(documentation Device EnglishLanguage \"A &%Device is an &%Artifact whose purpose is to serve as an &%instrument in a specific genls of &%Process.\")").
...
:- assert_kif("(genls Business CommercialAgent)").
:- assert_kif("(genls Business Organization)").
:- assert_kif("(documentation Business EnglishLanguage \"An &%instance of &%Business is an &%Organization that is a &%CommercialAgent.\")").
% :- assert_kif("; KJN: Removing this and putting in definition of Corporation that subclasses it from Business (genls Corporation CommercialAgent) (genls Corporation Organization)").
:- assert_kif("(genls Corporation Business) NS: add.").
:- assert_kif("(genls Corporation LegalAgent)").
...
:- assert_kif("(genls AgeGroup GroupOfPeople)").
...
:- assert_kif("(genls FamilyGroup GroupOfPeople)").
...
:- assert_kif("(genls SocialUnit GroupOfPeople)").
...
:- assert_kif("(genls EthnicGroup GroupOfPeople)").
...
:- assert_kif("(genls BeliefGroup GroupOfPeople)").
...
% :- assert_kif("; NS: delete. (genls Organization CognitiveAgent)").
% :- assert_kif("; NS: add.").
:- assert_kif("(genls Organization Agent)").
...
:- assert_kif("(genls MilitaryForce PoliticalOrganization)").
:- assert_kif("(documentation MilitaryForce EnglishLanguage \"&%MilitaryForce is the genls of &%Organizations that are organized along military lines and for the purpose of either defensive or offensive combat, whether or not the force is an official &%GovernmentOrganization.\")").
:- assert_kif("(=> (instance ?ORG MilitaryForce) (capability ViolentContest agent ?ORG))").
:- assert_kif("(genls MilitaryOrganization MilitaryForce)").
...
:- assert_kif("(genls ParamilitaryOrganization MilitaryForce)").
...
% :- assert_kif("; NS: add.").
:- assert_kif("(genls Government LegalAgent)").
...
:- assert_kif("(genls ComputerProgramming ContentDevelopment)").
...
:- assert_kif("(genls Argument Proposition)").
...
:- assert_kif("(genls InductiveArgument Argument)").
...
:- assert_kif("(documentation DirectionalAttribute EnglishLanguage \"The genls of &%PositionalAttributes that concern compass directions.\")").
...
:- assert_kif("(genls SymmetricPositionalAttribute PositionalAttribute)").
...
:- assert_kif("(genls AntiSymmetricPositionalAttribute PositionalAttribute)").
...
:- assert_kif("(genls SubjectiveStrongPositiveAttribute SubjectiveAssessmentAttribute)").
...
:- assert_kif("(genls SubjectiveWeakPositiveAttribute SubjectiveAssessmentAttribute)").
...
:- assert_kif("(genls SubjectiveStrongNegativeAttribute SubjectiveAssessmentAttribute)").
...
:- assert_kif("(genls SubjectiveWeakNegativeAttribute SubjectiveAssessmentAttribute)").
...
:- assert_kif("(genls ProbabilityAttribute ObjectiveNorm)").
...
% :- assert_kif("; NS: delete. Instances of SoundAttribute should also be instances of PerceptualAttribute, but SoundAttribute is a genls of RelationalAttribute, not of InternalAttribute. Some PerceptualAttributes are InternalAttributes. Others are RelationalAttributes. (genls PerceptualAttribute InternalAttribute)").
% :- assert_kif("; NS: add.").
:- assert_kif("(genls PerceptualAttribute Attribute)").
...
% :- assert_kif("; NS: delete. (genls ColorAttribute InternalAttribute)").
% :- assert_kif("; NS: add.").
...
:- assert_kif("(genls StructureAttribute InternalAttribute)").
:- assert_kif("(documentation StructureAttribute EnglishLanguage \"Each &%genls of &%StructureAttribute denotes some facet of the structure of physical entities. Each &%instance of &%StructureAttribute denotes some structural characteristic that may pertain to some &%Physical entity.\")").
:- assert_kif("(genls ShapeAttribute StructureAttribute)").
% :- assert_kif("; KJN: Delete as StructureAttribute already subclasses from InternalAttribute (genls ShapeAttribute InternalAttribute)").
