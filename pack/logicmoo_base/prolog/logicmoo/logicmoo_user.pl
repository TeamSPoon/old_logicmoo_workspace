...
% Douglas Miles
*/
:- if(('$set_source_module'(CM,CM),'$module'(M,M),asserta(logicmoo_user:user_module_uses(M,CM)))).
...
:- multifile(logicmoo_user:user_module_uses/2).
:- dynamic(logicmoo_user:user_module_uses/2).
