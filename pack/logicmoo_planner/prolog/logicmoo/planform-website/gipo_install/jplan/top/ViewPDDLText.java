...
/**
 * ViewPDDL Text
 * This class controls the plain text view of an PDDL domain
 */
...
public class ViewPDDLText
	...
	public ViewPDDLText(OclEd top) {
		super(top); /* Weihong added on 24/10/2001 */
		setTitle("PDDL Domain Specification");
		this.top = top;
//		if (top.curPDDLDomain == null) {
//			/* Weihong added on 5/11/2001 */
//			JOptionPane.showMessageDialog(
//				top,
//				"No PDDL Domain Currently Exists",
...
//			dia.show();
//		} else {
//			top.curPDDLDomain.pddlPrintComponent(
