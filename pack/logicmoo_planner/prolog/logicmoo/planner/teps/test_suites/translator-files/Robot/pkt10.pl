...
% %goal 8
% goal(F) :- sequence([at(o1,r2),at(o2,r4),at(o2,c1),at(o3,r3),at(o4,c4),at(o1,r2)],F).

% %goal 9
%goal(F) :- sequence([at(o1,r2),and(at(o1,r4),at(o2,r4)),and(at(o1,c1),at(o2,c1)),at(o3,r3),at(o4,c4),at(o1,r2)],F).

% %goal 10
goal(F) :- sequence([at(o1,r2),and(at(o1,r4),at(o2,r4)),and(at(o1,c1),at(o2,c1)),and(at(o1,r3),at(o3,r3)),at(o4,c4),at(o1,r2)],F).
