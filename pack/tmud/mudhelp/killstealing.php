...
<title>The Two Towers Help - Rules and Policies - Killstealing</title>
...
<br>
<h2>Killstealing (Rules and Policies)</h2><p>Corpselooting or killstealing is behaviour in which one player starts
...
</p><ol style="list-style-type:decimal"><li>When an NPC dies, the person or party who did the most damage to the
...
</li><li>This protection is also extended to skinnable corpses; for ten seconds,
...
hand!
</li><li>Many quests that let you gain loot from the ground or chests have also
been altered for similar protection - for 10 seconds, only the quester
will be able to gather the loot.
</li></ol><p>Of course, these protections are not infallible (and limited in time),
...
</p><p>It should be noted that while the system protections are fleeting -
...
</p><p>Also, be aware that *repeated* killstealing/corpselooting (ie.
...
<div style="margin:0px;padding;0px;margin-left:10px"><a href="topics.php">topics</a>, <a href="rules.php">rules</a>, <a href="contracts.php">contracts</a></div>
</td></tr></table>
