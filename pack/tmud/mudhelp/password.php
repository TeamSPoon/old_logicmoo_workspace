...
<title>The Two Towers Help - Technical Help - Password</title>
...
<br>
<h2>Password (Technical Help)</h2><p>The password you choose for your character is like your own personal
...
</p><p>Someone could steal your key if it's not well-made.  You could lose
...
</p><p>Here's some rules and tips about passwords that you NEED to know:
</p><ol style="list-style-type:decimal"><li><p>Memorize Memorize MEMORIZE!
</p><p>I can't stress that enough.  Don't make your password and then
...
</p></li><li><p>Make it hard to "guess".
</p><p>While trying to keep it easy for you to memorize, you'll also have
...
</p></li><li><p>Do NOT use your MUD client's auto login feature.
</p><p>It's a handy feature, but when your zmud crashes you've just lost
...
</p></li><li><p>Watch your login screen.
</p><p>And finally, if you ever get a "login failure" error when you log in
...
</li><li>Make it hard to guess
</li><li>Don't use auto-login feature
</li></ul><p>If you lose your password, there is only one way to recover it: using
the automatic password recovery system at our web page address:
</p><p><a href="http://www.t2tmud.org/password.php"target="_blank">http://www.t2tmud.org/password.php</a>
</p><p>While the password cannot be retrieved it can be reset by the system.
...
</p><p>The reset code is valid for one hour and if used, will substitute your
...
</p><p>Note that you MUST provide a valid e-mail address through the MUD's
...
</p><p>Each player is responsible for their own password and e-mail address.
...
</p><p>Your e-mail address information can only be read by MUD administrators.
</p><p>To change your password at any time, use the 'passwd' command.
...
<div style="margin:0px;padding;0px;margin-left:10px"><a href="topics.php">topics</a>, <a href="technical.php">technical</a>, <a href="passwd.php">passwd</a>, <a href="chfn.php">chfn</a></div>
</td></tr></table>
