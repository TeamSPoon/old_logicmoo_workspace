...
<title>The Two Towers Help - General Help - Semotes</title>
...
<br>
<h2>Semotes (General Help)</h2><p>Soul emotes, or semotes are a set of built in actions for you to do.
...
</p><p>There are two types of semotes: targeted and untargeted.  Some are only
...
</p><p>Most semotes have a place to add your own modifier.  You might want to
...
</p><p>Internally there are two types of modifiers: override &amp; invisible.
</p><p>The override modifier always appears unless the player types their own
...
</p><p>The invisible modifier never appears unless the player specifies they
want to see it by typing a period after the semote, eg: "smile ."
</p><p>In both cases, if the player types their own modifier, that is what
...
<div style="margin:0px;padding;0px;margin-left:10px"><a href="topics.php">topics</a>, <a href="game_concepts.php">game concepts</a>, <a href="semote.php">semote</a>, <a href="set.php">set</a>, <a href="say.php">say</a>, <a href="emote.php">emote</a></div>
</td></tr></table>
