...
<title>The Two Towers Help - Rules and Policies - Client abuse</title>
...
<br>
<h2>Client abuse (Rules and Policies)</h2><p>Every so often, it comes to our attention that people have decided
...
the line.
</p><p>The two primary ways that clients can be abused are as follows:
</p><ol style="list-style-type:decimal"><li>When Player A intentionally abuses/misuses Player B's client scripts
...
</li><li>When Player A configures his or her client in such a way that it
crosses the line into botting.  There are two main subitems here:
<ol style="list-style-type:lower-alpha"><li>"Classic" botting, where a client runs through a series of
commands, performing actions such as killing mons, healing,
selling gear and banking gold, all without requiring any input
from the typist.  See "<a href="botting.php">help botting</a>" for more on this.
</li><li>"Call-and-Response" botting, where a player configures his or 
...
</li></ol></li></ol><p>Both of these scenarios provide what we consider to be an unfair
...
<div style="margin:0px;padding;0px;margin-left:10px"><a href="topics.php">topics</a>, <a href="rules.php">rules</a>, <a href="triggers.php">triggers</a>, <a href="botting.php">botting</a></div>
</td></tr></table>
