...
<title>The Two Towers Help - Objects Help - Flying mounts</title>
...
<br>
<h2>Flying mounts (Objects Help)</h2><h3>Overview</h3><p>Apart from allowing you to ride various mounts on land, The Two Towers
...
</p><h3>Movement</h3><p>You can "mount" a flying mount just like a regular one.  However, from
...
</p><p>While in flight, you may fly "up" and "down" to change your altitude.
...
</p><p>When you want to dismount your flying mount, you first have to "land"
...
</p><p>When the beast moves, the rider will see the 1-line short description
...
</p><p>While mounted on a flying beast, you cannot look at or pick up any
...
they're in the room.
</p><h3>Map</h3><p>You will notice that while you are mounted on a flying beast, your
"map" command will display a slightly bigger map; it is easier to detect
your surroundings from a higher altitude!
</p><h3>Combat</h3><p>Air combat is more than a stationary fight like with monsters; it is a
...
</p><p>Movement attacks are the "dive" and the "scrape":
</p><ul><li>A dive attack is when a player at a higher altitude dives down on his
enemy, doing a dive damage bonus attack.
</li><li>A scrape attack is when a beast moves into or through a room with 
...
</li></ul><p>During combat, the rider will take damage a portion of the time and
...
</p><p>Apart from these two, the flying mounts have their own special attacks:
eagles can "claw", while fell beasts can "bite".
</p><h3>Death</h3><p>If the rider dies while on the beast, he becomes a ghost and floats
down to the ground.
</p><p>If the beast dies in combat, it will begin falling to the ground.
...
</p><h3>Endurance</h3><p>All beasts tire while in flight.  If your beast begins to tire, you
...
<div style="margin:0px;padding;0px;margin-left:10px"><a href="topics.php">topics</a>, <a href="special_objects.php">special objects</a>, <a href="mounts.php">mounts</a></div>
</td></tr></table>
