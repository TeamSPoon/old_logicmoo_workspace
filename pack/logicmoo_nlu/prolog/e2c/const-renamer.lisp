...
(csetq  *typeprefixes* `(
(#$Action "act" "tAct" "iAct_")
(#$Goal  "goal" "tGoal" "iGoal_" )
(#$Capability  "cap"  "tCap" "cap")
(#$IBTContentType "tIbo" "tIbo" "ibo")
(#$Event  "tEvent" "tEvent" "iEvent_")  
(#$Situation  "state" "tState" "iState_")
(#$FormulaTemplate  "ui_" "uiTopic_" "iUI_")
(#$Topic  "ui_" "uiTopic_" "iUI_")
(#$PhysicalPartOfObject "tPartType" "tPartType" "iPartType_")
(#$SpecifiedPartTypeCollection "ttPartType" "ttPartType" "tPartType")
(#$OrganismClassificationType  "tTypeOf" "ttTypeOf" "tClassificationOf_")
(#$ConventionalClassificationType  "tTypeOf" "ttTypeOf" "tClassificationOf_")

(#$SpaceRegion "tPlace"  "tPlaceLike" "iLoc_")

(#$TwoDimensionalThing     "tPlacePartOf"  "tPlacePartOf" "iLocPart_")
;; (#$AbstractVisualStructure "tPlacePartOf"  ttPlacePartOf" "iLocPart_")
(#$OpenGISGeometry         "tPlacePartOf"  "tPlacePartOf" "iLocPart_")
...
(#$Predicate  "iPred_" "rt" nil)
(#$Function-Denotational  "iFunc_" "rt" nil)
(#$Relation  "iRel_" "rt" nil)
(#$PredicateType  "rt" "ttRel" "rt")
(#$FunctionType  "iFunc_" "ttRel" "rt")
(#$RelationshipType  "iRel_" "ttRel" "rt")
(#$SubLExpressionType  "ft" "ft" "ft")
(#$Group  "tGrouped" "tGrouped" "iGroup_")
(#$Artifact  "tObject" "tObject" "iObj_")  
(#$Place  "tPlace"  "ttPlaceLike" "iLoc_")
(#$Microtheory  "mt" "mt" "mt")
...
(#$AnalogyEntityWithStructuralEvaluation "cw" "cw" "iCW_")

(#$TheList "u" "ut" "u")
;; (#$Tuple  "v" "vt" "v")
(#$Tuple  "u" "ut" "u")
(#$ProgramObject "s_cw" "s_cw" "s_iCW_")
(#$Field-LogicalOrPhysical "s_db" "s_db" "s_iDB_")
(#$Schema-LogicalOrPhysical "s_db" "s_db" "s_iDB_")
(#$CycSubjectClump "ui_" "uiTopic_" "iUI_")
))
...
(define guess-fn-prefix (trm)
 ...
 (pcond
  ((isa-p trm #$FunctionDenotingFunction) (ret "iFunc_"))
  ((isa-p trm #$PredicateDenotingFunction) (ret "iPred_"))
  ((result-isa-p trm #$SetOrCollection) (ret "tSetOf"))  
  ((isa-p trm #$SetDenotingFunction) (ret "tSetOf"))
  ((isa-p trm #$MicrotheoryDesignatingFunction-Denotational) (ret "mt"))  
  ...
  ((isa-p trm #$CodingFunctionTypeByOperationType) (ret "s_iCW_"))
  ((isa-p trm #$CodingFunction) (ret "s_iCW_"))
  ((isa-p trm #$StandardLibraryFunction) (ret "s_iCW_"))
  ((result-isa-p trm #$Field-LogicalOrPhysical) (ret "tSetOf"))
  )

(pcond
  ((result-isa-p trm #$SpatialThing-Localized) (ret "i"))
  ((isa-p trm #$RelationDenotingFunction) (ret "iRel_"))
...
(define guess-rename (trm &optional str prefixstr)
 ...
 (pwhen (isa-p trm #$LearnedActivityType) (ret (cconcatenate "act" str )))
...
(define guess-prefix3 (trm)
 ...
 ((isa-p trm #$MicrotheoryType) (ret "mt"))
 ((genls-p trm #$FormulaTemplateTopicType) (ret "uiTopic_"))
...
(define namet()
 ...
 (offer-prefix #$SubPathBetweenFn "iLoc_")
 ...
 (offer-prefix #$IntensionOfQuerySentenceFn "iCW_")
 ...
 (offer-prefix #$TableCellValueFn "s_iDB_")
 (offer-prefix #$FieldValueFn "s_iDB_")
 (offer-prefix #$RDFTypedLiteralFn "r")
 (offer-prefix #$GeneLocusFn "iPlace")
 (offer-prefix #$CiFn "iCW_")
 (offer-prefix #$AnalogyMappingIDFn "iCW_")
 (offer-prefix #$Reminding-AnalogyFn "iCW_")
 (offer-prefix #$AnalogyMatcherFn "iCW_")
 (offer-prefix #$ExecutableFunctionFn "s_iCW_")
 
)

(define namet2()
 (cdolist (trm (ALL-INSTANCES #$LearnedActivityType)) (offer-prefix trm "act"))
 (cdolist (ts *typeprefixes*)
