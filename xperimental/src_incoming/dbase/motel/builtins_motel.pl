...
assert(roleDefault(env(fssKB),[],truth_mod,bot)).
...
assert(roleDefault(env(fssKB),[],det,bot)).
assert(roleDefault(env(fssKB),[],deictic_mod,bot)).
assert(roleDefault(env(fssKB),[],named,bot)).
assert(roleDefault(env(fssKB),[],subject,bot)).
assert(roleDefault(env(fssKB),[],purpose,bot)).
assert(roleDefault(env(fssKB),[],time,bot)).
assert(roleDefault(env(fssKB),[],illoc,bot)).
assert(roleDefault(env(fssKB),[],cause,bot)).
assert(roleDefault(env(fssKB),[],result,bot)).
assert(roleDefault(env(fssKB),[],location,bot)).
assert(roleDefault(env(fssKB),[],time_state,bot)).
assert(roleDefault(env(fssKB),[],volition,bot)).
assert(roleDefault(env(fssKB),[],origin_mod,bot)).
assert(roleDefault(env(fssKB),[],agent,thing)).
assert(roleDefault(env(fssKB),[],location_wohn,bot)).
assert(roleDefault(env(fssKB),[],colour_mod,bot)).
assert(roleDefault(env(fssKB),[],relative_mod,bot)).
assert(roleDefault(env(fssKB),[],material_mod,bot)).
assert(roleDefault(env(fssKB),[],weight_mod,bot)).
assert(roleDefault(env(fssKB),[],agent,human)).
assert(roleDefault(env(fssKB),[],instrument,bot)).
assert(roleDefault(env(fssKB),[],concerned,bot)).
assert(roleDefault(env(fssKB),[],destination,bot)).
assert(roleDefault(env(fssKB),[],source,bot)).
...
assert(roleDefault(env(fssKB),[],beneficative,bot)).
assert(roleDefault(env(fssKB),[],has_property,bot)).
assert(roleDefault(env(fssKB),[],measure,bot)).
assert(roleDefault(env(fssKB),[],measure,abstract_thing)).
assert(roleDefault(env(fssKB),[],has_property_haben,bot)).
assert(roleDefault(env(fssKB),[],quantity,cardinal)).
assert(roleDefault(env(fssKB),[],physis_mod,bot)).
assert(roleDefault(env(fssKB),[],volition,bot)).
assert(roleDefault(env(fssKB),[],worth_mod,bot)).
