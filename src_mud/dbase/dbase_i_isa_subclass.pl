...
not_mud_isa0(I,ftFormatting):-!,not(compound(I)).
...
define_ft_0(Spec):- hooked_asserta(isa(Spec,ttFormatType)),(compound(Spec)->hooked_asserta(isa(Spec,ftFormatting));true).
