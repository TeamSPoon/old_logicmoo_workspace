...
decl_mpred_0(F/A,More):-atom(F),!,decl_mpred_2(F,predArity(A)),decl_mpred(F,More),!.
...
decl_mpred_2(F,prologHybrid):- ensure_universal_stub(F).
...
decl_mpred_2(F,A):-once(provide_mpred_write_attributes(F,A)).
