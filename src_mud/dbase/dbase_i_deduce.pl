...
deduce_facts_forward(predArgTypes(ArgTs),mpred_prop(F,predArgTypes(ArgTs))):-get_functor(ArgTs,F),assert_predArgTypes_fa(F,ArgTs).
deduce_facts_forward(mpred_prop(F,predArgTypes(ArgTs)),predArgTypes(ArgTs)):-get_functor(ArgTs,F),assert_predArgTypes_fa(F,ArgTs).

deduce_facts_forward(predArgTypes(ArgTs),argIsa(F,A,Type)):-get_functor(ArgTs,F,_),arg(A,ArgTs,Type).
deduce_facts_forward(mpred_prop(F,predArgTypes(ArgTs)),argIsa(F,A,Type)):-arg(A,ArgTs,Type).
